...
<template>
    ...
    >
        ...
        >
            <div class="flex w-full  max-w-[335px] lg:max-w-4xl justify-end py-4">
                <div v-if="usePage().props.auth === null" class="flex gap-4">
                    
                    <Link :href="route('login')" class="px-4 py-2 transition duration-300 border-stone-700 bg-stone-800 hover:bg-stone-700 text-stone-200 rounded-md w-fit" view-transition>
                        Login
                    </Link>
                    <Link :href="route('register')" class="px-4 py-2 transition duration-300 border-stone-700 bg-stone-800 hover:bg-stone-700 text-stone-200 rounded-md w-fit" view-transition>
                        Register
                    </Link>
                </div>
            ...
            <div class="mt-4 w-full max-w-[335px] lg:max-w-4xl">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-linear-to-br from-[#42b883]/10 to-[#35495e]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(66,184,131,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(66,184,131,0.5)] dark:from-[#42b883]/20 dark:to-[#35495e]/20">
                    ...
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-linear-to-br from-[#9553e9]/10 to-[#6c2bd9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(149,83,233,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(149,83,233,0.5)] dark:from-[#9553e9]/20 dark:to-[#6c2bd9]/20">
                        <div class="mb-3 flex items-center gap-3">
                    ...
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-linear-to-br from-[#06b6d4]/10 to-[#0ea5e9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(6,182,212,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(6,182,212,0.5)] dark:from-[#06b6d4]/20 dark:to-[#0ea5e9]/20">
                        <div class="mb-3 flex items-center gap-3">
