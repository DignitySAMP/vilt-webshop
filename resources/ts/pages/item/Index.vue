                            ...
                            <tr v-for="product in products" :key="product.id" class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <img :src="product.image" class="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-xl"/>
                                ...
                                <td class="px-6 py-4 text-slate-900 font-medium">${{ product.price.toFixed(2) }}</td>
                                
                                <td class="px-6 py-4">
                                    <span :class="[
                                        'text-sm font-medium',
                                        product.stock > 50 ? 'text-green-600' : product.stock > 20 ? 'text-yellow-600' : 'text-red-600'
                                    ]">
                                        {{ product.stock }} units
                                    </span>
                                </td>
