...
<template>
    ...
    >
        <div
            class="flex w-full flex-col items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0"
        >
            <div
                class="flex w-full max-w-[335px] justify-end py-4 lg:max-w-4xl"
            >
            ...
            <div class="mt-4 w-full max-w-[335px] lg:max-w-4xl">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-linear-to-br from-[#42b883]/10 to-[#35495e]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(66,184,131,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(66,184,131,0.5)] dark:from-[#42b883]/20 dark:to-[#35495e]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            ...
                            <h3
                                class="text-lg font-semibold text-[#35495e] dark:text-[#42b883]"
                            >
                                Vue.js
                            </h3>
                        </div>
                        ...
                        >
                            The progressive JavaScript framework for building
                            modern, reactive user interfaces. Vue 3 offers the
                            Composition API, improved performance, and better
                            TypeScript support.
                        </p>
                        <a
                    ...
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-linear-to-br from-[#9553e9]/10 to-[#6c2bd9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(149,83,233,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(149,83,233,0.5)] dark:from-[#9553e9]/20 dark:to-[#6c2bd9]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            <svg
                                class="h-8 w-8"
                            ...
                            <h3
                                class="text-lg font-semibold text-[#6c2bd9] dark:text-[#9553e9]"
                            >
                                Inertia.js
                            </h3>
                        </div>
                        <p
                            class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]"
                        >
                            The modern monolith approach. Build single-page
                            applications without the API complexity. Inertia
                            seamlessly bridges Laravel and Vue with server-side
                            routing.
                        </p>
                        <a
                    ...
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-linear-to-br from-[#06b6d4]/10 to-[#0ea5e9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(6,182,212,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(6,182,212,0.5)] dark:from-[#06b6d4]/20 dark:to-[#0ea5e9]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            <svg
                                class="h-8 w-8"
                            ...
                            <h3
                                class="text-lg font-semibold text-[#0ea5e9] dark:text-[#06b6d4]"
                            >
                                Tailwind CSS
                            </h3>
                        </div>
                        ...
                        >
                            ...
                            development. Build custom designs without leaving
                            your HTML. Tailwind 4 brings improved performance
                            and native cascade layers.
                        </p>
                        <a
