<template>
    <AppLayout>
        <div class="flex flex-col gap-2">
            ...
            <span class="text-sm text-gray-700"> If you forgot your password, enter your e-mail below to recieve an e-mail with a reset link. </span>
            ...
            <div class="flex justify-between text-sm text-gray-600">
                <Link :href="route('login')" class="hover:underline" view-transition> Remember your credentials? </Link>
